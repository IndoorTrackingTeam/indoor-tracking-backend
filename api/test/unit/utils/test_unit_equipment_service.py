...
@patch('src.utils.equipment_service.RouterDataDAO.get_last_data')
@patch('src.utils.equipment_service.EquipmentDAO.get_current_room_and_date')
@patch('src.utils.equipment_service.EquipmentDAO.get_all_esp_id')
@patch('src.utils.equipment_service.requests.get')
@pytest.mark.asyncio
async def test_update_equipments_location_success(mock_get, mock_get_all_esp_id, mock_get_current_room_and_date, mock_get_last_data):
...
@patch('src.utils.equipment_service.EquipmentDAO')
@patch('src.utils.equipment_service.requests.get')
@pytest.mark.asyncio
